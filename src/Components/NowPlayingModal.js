...
const NowPlayingModal = ({ nowPlayingUrl, nowPlayingTitle, closeModal }) => {
  return (
    <div className="vh-100 w-100 custom-modal d-flex align-items-center justify-content-center custom-modal-form">
      <X className="x mt-2 mr-2" size={24} onClick={closeModal} />
      <div className="container d-flex flex-column align-items-center justify-content-center p-2 h-25">
